 ...
 *
 */
namespace Joaktree\Plugin\EditorsXtd\Joaktreemap\Extension;
// no direct access
...
class Joaktreemap extends CMSPlugin implements SubscriberInterface
{
    /**
	...
	function onDisplay($name)
	{
        ...
        if (!$wa->assetExists('script', 'editor-button.' . $this->_name)) {
            $wa->registerScript(
                ...
                'com_joaktree/admin-article-joaktreemap.js',
                [],
                [],
		 ...
		 */
		$link = 'index.php?option=com_joaktree&amp;view=maps&amp;layout=element&amp;tmpl=component&amp;'.Session::getFormToken().'=1';
        ...
        $button = new Button(
            ...
            [
                'action'  => 'modal',
                'link'    => $link,
                'text'    => Text::_('PLG_JOAKTREE_BUTTON_MAP'),
                'icon'    => 'map-signs',
