...
<form 
	action="<?php echo Route::_('index.php?option=com_joaktree&view=applications'); ?>" 
	method="post" 
	id="adminForm" 
	name="adminForm"
>
			...
			<thead>
				<tr>
					...
					<th class="nowrap hidden-phone">
						<?php echo HtmlHelper::_('grid.sort', 'JTAPPS_HEADING_TITLE', 'japp.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo HtmlHelper::_('grid.sort', 'JTAPPS_HEADING_DESCRIPTION', 'japp.description', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo HtmlHelper::_('grid.sort', 'JTAPPS_HEADING_PROGRAM', 'japp.programName', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo HtmlHelper::_('grid.sort', 'JTAPPS_HEADING_PERSONS', 'NumberOfPersons ', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
