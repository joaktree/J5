...
<form 
	action="<?php echo Route::_('index.php?option=com_joaktree&view=trees'); ?>" 
	method="post" 
	id="adminForm" 
	name="adminForm"
>
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th class="nowrap hidden-phone">
						<?php echo HTMLHelper::_('grid.sort', 'JTFAMTREE_HEADING_APPTITLE', 'japp.title', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo Text::_('JTFAMTREE_HEADING_NUMBEROFPERSONS'); ?>
					</th>				
					<th class="nowrap hidden-phone">
						<?php echo HTMLHelper::_('grid.sort', 'JTFAMTREE_HEADING_GENDEX', 'jte.indGendex', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone"> 
					...
					<th class="nowrap hidden-phone">
						<?php echo HTMLHelper::_('grid.sort', 'JT_HEADING_ACCESS', 'access_level ', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					<th class="nowrap hidden-phone">
						<?php echo HTMLHelper::_('grid.sort', 'JT_HEADING_THEME', 'theme ', $this->lists['order_Dir'], $this->lists['order']); ?>
					</th>
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="nowrap hidden-phone">
							<?php if ($this->canDo->get('core.edit')) { ?>
								<a href="javascript:void(0);" onclick="<?php echo $click; ?>" title="<?php echo Text::_('JTFAMTREE_TOOLTIP_EDIT'); ?>">
						...
						<td class="small hidden-phone">
							<?php echo Text::_(($row->indGendex == 2) ? 'JYES' : 'JNO'); ?>
						</td>
						<td class="small hidden-phone">
