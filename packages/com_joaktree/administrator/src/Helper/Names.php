...
class Names extends \StdClass
{
    ...
    */
    public static function setFamilyName(&$inputName, &$persons, &$familynameSetting)
    {
        $ret = true;
