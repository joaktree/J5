...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sels.forEach(function (element) {
        ...
        element.parentNode.parentNode.style.marginRight = '1em';
    });
    sels = sel.querySelectorAll('input.half');
    sels.forEach(function (element) {
        element.parentNode.parentNode.style.width = '50%';
        element.parentNode.style.width = '50%';
        element.parentNode.style.marginRight = '1em';
    });
    ...
    sels = sel.querySelectorAll('div.third.radio');
    sels.forEach(function (element) {
        element.parentNode.parentNode.parentNode.style.width = '30%';
        element.parentNode.parentNode.style.width = '30%';
        element.parentNode.parentNode.style.marginRight = '1em';
    });
    sels = sel.querySelectorAll('input.third');
    sels.forEach(function (element) {
        element.parentNode.parentNode.style.width = '30%';
        element.parentNode.style.width = '30%';
        element.parentNode.style.marginRight = '1em';
    });
    sels = sel.querySelectorAll('div.third:not(.radio)');
    sels.forEach(function (element) {
        element.parentNode.parentNode.parentNode.style.width = '30%';
        element.parentNode.parentNode.style.width = '30%';
        element.parentNode.style.width = '30%';
