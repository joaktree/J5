...
<script type="text/javascript">
	...
	{
		if (task == 'cancel' || document.formvalidator.isValid(document.getElementById('partnerForm'))) {
...
<div id="jt-form"> 
<form action="<?php echo Route::_('index.php?option=com_joaktree'); ?>" method="post" name="partnerForm" id="partnerForm" class="form-validate">
...
<div class="fltlft">
	...
	<fieldset class="joaktreeform">
		<legend><?php echo Text::_('JT_EDITPARTNERS'); ?></legend>
